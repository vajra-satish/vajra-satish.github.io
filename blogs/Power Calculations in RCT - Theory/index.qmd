...
Researchers usually use a power size of 0.8 or higher. In many situations we expect to have a minimum detectable effect size of 0.2 standard deviations.
:::
