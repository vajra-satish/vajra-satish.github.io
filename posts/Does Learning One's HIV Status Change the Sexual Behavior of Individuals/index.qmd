...
summary(iv_reg)
```
The LATE estimate is statistically significant. Therefore, we can come to a conclusion that learning about one's HIV positive status increases the likelihood of purchasing condoms by a statisitcally significant margin. 
# Work in Progress